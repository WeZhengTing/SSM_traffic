...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation"
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="<%=basePath%>customer/list.action">交通客户信息管理</a>
		</div>
		<!-- 导航栏右侧图标部分 -->
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu dropdown-messages">
					<li>
						<a href="#">
							<div>
								<strong>刘经理</strong> <span class="pull-right text-muted">
								<em>昨天</em>
							</span>
							</div>
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li>
						<a href="${pageContext.request.contextPath }/Administrator/sign">
							<i class="fa fa-dashboard fa-fw" ></i> 添加管理员
						</a>
					</li>
				</ul>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get"
					...
					<div class="form-group">
						<label for="custLevel">用户类型</label>
					...
					<table class="table table-bordered table-striped">
						...
						<c:forEach items="${page.rows}" var="row">
							<tr>
								...
								<td>${row.cust_policeno}</td>
								<td>${row.cust_license}</td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="new_customer_form">
					...
					<div class="form-group">
						<label for="new_count" class="col-sm-2 control-label">账户</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="new_count" placeholder="账户" name="cust_count" />
						</div>
					</div>
					<div class="form-group">
						<label for="new_policeno" class="col-sm-2 control-label">警号</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="new_policeno" placeholder="固定电话" name="cust_policeno" />
						</div>
					</div>
					<div class="form-group">
						<label for="new_license" class="col-sm-2 control-label">驾照分数</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="new_license" placeholder="驾照分数" name="cust_license" />
						</div>
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="edit_customer_form">
					...
					<div class="form-group">
						<label for="edit_policeno" class="col-sm-2 control-label">警号</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="edit_policeno" placeholder="警号" name="cust_policeno" />
						</div>
					</div>
					<div class="form-group">
						<label for="edit_license" class="col-sm-2 control-label">驾照分数</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="edit_license" placeholder="驾照分数" name="cust_license" />
						</div>
					</div>
					<div class="form-group">
						<label for="edit_count" class="col-sm-2 control-label">账户</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="edit_count" placeholder="账户" name="cust_count" />
						</div>
					</div>
					<div class="form-group">
	...
	function editCustomer(id) {
		$.ajax({
			...
			success:function(data) {
				...
				$("#edit_policeno").val(data.cust_policeno);
				$("#edit_count").val(data.cust_count);
				$("#edit_license").val(data.cust_license);
			}
		});
	}
	// 执行修改客户操作
