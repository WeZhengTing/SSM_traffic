...
<div ALIGN="center">
	<table border="0" width="1140px" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<td width="430px"> <marquee direction="lift" ><b style="color: red;font-size: 32px">北京市第三交通委员会提醒您：道路千万条，安全第一条。行车不规范，亲人两行泪。</b>  </marquee></td>       <!--滚动提示字幕-->
			<td class="login_msg" width="400" align="center">
				<!-- margin:0px auto; 控制当前标签居中 -->
				<fieldset style="width: auto; margin: 0px auto;color: cyan">
					<legend>
						<font style="font-size:15px" face="宋体">
							<b style="color: darkorchid">欢迎使用交通用户信息管理系统</b>
						</font>
					</legend>
					<font color="red">
						<%-- 提示信息--%>
					...
					<form action="${pageContext.request.contextPath }/login.action"
						...
						<br/><br/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<center><input type="button" value="用户注册" onclick="window.location='/login_null'"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="submit" value="管理员登录" /></center>
					</form>
				</fieldset>
			</td>
		</tr>
