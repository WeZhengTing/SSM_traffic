...
public class Customer implements Serializable {
    ...
    private Integer cust_policeno;
    private Integer cust_license;
    private Integer start;
    private Integer rows;

    public Integer getCust_license() {
        return cust_license;
    }

    public void setCust_license(Integer cust_license) {
        this.cust_license = cust_license;
    }

    public Integer getCust_policeno() {
        return cust_policeno;
    }

    public void setCust_policeno(Integer cust_policeno) {
        this.cust_policeno = cust_policeno;
    }
